...
import { ConfigAccessGroupsPermissionsGroupCard } from "#components";
        ...
        <div class="max-w-[1008px] mx-auto flex flex-col w-full gap-10">
          <div class="w-full md:w-auto">
            ...
            <p class="text-[0.813rem] text-dashboard-text">
              Set up your own rules for what team members can do
            </p>
          </div>
          ...
          <div class="flex flex-col gap-5">
            ...
            <div class="w-full collapsable" :class="{ show: !isCollapsed }">
              ...
              <div class="collapsable-content">
                ...
                <!-- not found -->
                <!-- <div
                class="border min-h-[60vh] border-dashboard-card-border"
              ></div> -->
                <!-- not found end -->
              </div>
            </div>
